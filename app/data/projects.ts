...
export const projects: Project[] = [
  ...
  },
  {
    ...
    body: 'DRUMS, Pa., April 14 — In a development which surprised observers in both the manufacturing and creative technology sectors, Mr. Brian Lapinski has been named a 2026 Mover and Shaker by the Choice Dao community. Your correspondent has learned from reliable quarters that the distinction recognizes Mr. Lapinski\'s unusual trajectory — fifteen years supervising production lines, earning a Lean Six Sigma Black Belt from Villanova University, and building systems that turned, as one associate put it, "chaos into process." It is this same operational discipline that Mr. Lapinski now applies to what he calls his Style DNA methodology — a systematic approach to artificial intelligence image generation that treats the craft not as random experimentation but as reproducible constraint satisfaction. Sources close to the artist indicate that each variable defining a visual style is isolated and systematically adjusted until the output matches the intent. It is, in essence, the factory floor applied to the canvas.',
